...
select "Composer" , avg("Milliseconds") as "duracion_promedio", stddev("Milliseconds") as "desviacion_estandar", variance("Milliseconds") as "varianza" 
from "Track" t 
group by "Composer" 
...
select concat("FirstName", ' ', "LastName"), "Country" 
from "Customer" c 
